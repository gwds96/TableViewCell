...
class CatalogueVC: UIViewController, UITableViewDataSource {
    ...
    @IBOutlet weak var shopColView: UINavigationItem!
    ...
    let titleList = ["Quán ăn","Mẹ & Bé","Rạp chiếu phim","Thời trang/Phụ kiện","Thiết bị số & Công nghệ","Mỹ phẩm/Làm đẹp","Khách sạn","Giáo dục","Sức khoẻ","Dịch vụ khác"]
